...
public final class GameProject {
    ...
    public static final class ParticlePreset {public final String key;public String name,assetKey="";public double rate=10,lifetime=1,speed=1,spread=45,direction=-90,gravity,startScale=1,endScale=.2,startOpacity=1,endOpacity=0;public boolean burst,localSpace=true;public int burstCount=12;public ParticlePreset(String key,String name){this.key=key;this.name=name==null?key:name;}public ParticlePreset copy(){return copyAs(key);}public ParticlePreset copyAs(String newKey){ParticlePreset c=new ParticlePreset(newKey,name);c.assetKey=assetKey;c.rate=rate;c.lifetime=lifetime;c.speed=speed;c.spread=spread;c.direction=direction;c.gravity=gravity;c.startScale=startScale;c.endScale=endScale;c.startOpacity=startOpacity;c.endOpacity=endOpacity;c.burst=burst;c.localSpace=localSpace;c.burstCount=burstCount;return c;}@Override public String toString(){return key;}}
