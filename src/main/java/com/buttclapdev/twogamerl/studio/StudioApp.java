...
public final class StudioApp extends Application {
    ...
    private void updateTitle(){if(stage==null)return;String title="2gameRL Studio 2.3 RC3 · "+project.getTitle()+(dirty?"  ●":"");stage.setTitle(title);windowTitle.setText(title);}
