...
public final class StudioApp extends Application {
    ...
    void error(String header,String message){StudioDialogs.error(stage,header,message==null?"Error desconocido":message);}void info(String header,String message){StudioDialogs.info(stage,header,message);}
